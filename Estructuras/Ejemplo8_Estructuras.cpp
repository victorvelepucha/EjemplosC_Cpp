...
int main()
{
    ...
    //Asignacion con punteros y NEW
    Cliente *cliente7 = new Cliente;
    cout << "Cliente7 :";
    cin.getline(cliente7->nombre, 20);cin.sync(); // getline lee retorno de carro no leído en cin
    cout << "Unidad :";
    ...
    cout << "Los datos del cliente7 son: " << cliente7->nombre << ", " << cliente7->numUnidades << ", " << cliente7->precio << ", " << cliente7->estado << endl;
    delete cliente7;
